...
public class Main {
    ...
    public static Product[] createMenu() {
        var menu = new Product[5];
        menu[0] = new Product("Cesar");
        menu[1] = new Product("California");
        menu[2] = new Product("Filadelfia");
        menu[3] = new Product("Fried duck");
        menu[4] = new Product("Uha");
        return menu;
    }
